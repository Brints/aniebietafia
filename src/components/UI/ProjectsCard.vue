...
<template>
  <div class="font-lora bg-gray-800 rounded-xl border border-gray-700 overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:border-blue-500 group">
    <!-- Project Image -->
